...
figure()
%reshape eigenvector of minimal eigenvalue into array for plotting
heat_array=reshape(V(:,1),[p,p])';
h=heatmap(heat_array, 'CellLabelColor', 'none');
% Set color limits
...
colorbar("off")
title("Basis vector for critical pattern space")
